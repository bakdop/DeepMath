...
#SBATCH --job-name=deepmath-rl-from-sft-llama
#SBATCH --nodes=1
...
RUN_NAME=llama3.2-1B-Instruct-DeepMath-SFT-then-rl
...
# NOTE: this expects an SFT-tuned Llama-3.2-1B checkpoint at the path below.
# Update MODEL_PATH to wherever your SFT run saved the final checkpoint.
MODEL_PATH=/scratch/bl4363/models/Llama-3.2-1B-Instruct-DeepMath-SFT-final
