...
#SBATCH --job-name=deepmath-rl-from-opd-llama
#SBATCH --nodes=1
...
RUN_NAME=llama3.2-1B-Instruct-nemotron-nano-8B-rl-from-opd
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.resume_mode=$MODEL_DIR/deepmath-llama/llama3.2-1B-Instruct-nemotron-nano-8B-opd/global_step_60 \
