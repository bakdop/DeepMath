...
#SBATCH --job-name=deepmath-kdrl-llama
#SBATCH --nodes=1
...
RUN_NAME=llama3.2-1B-Instruct-nemotron-nano-8B-kdrl
...
ADV_ESTIMATOR=grpo_opd
OPD_BETA_INIT=2e-1
OPD_BETA_END=2e-3
OPD_BETA_DELTA=1.6e-3
...
python3 -m verl.trainer.main_ppo \
    ...
    algorithm.opd_beta_init=$OPD_BETA_INIT \
    algorithm.opd_beta_end=$OPD_BETA_END \
    algorithm.opd_beta_delta=$OPD_BETA_DELTA \
