...
RUN_NAME=qwen3-1.7B-Base-qwen3-8B-nonthinking-grpo
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.resume_mode=/scratch/bl4363/DeepMath/models/deepmath-new/qwen3-1.7B-Base-qwen3-8B-opd/global_step_60 \
